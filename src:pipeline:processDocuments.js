...
const dropboxFolderPath = "/DAYTRADING AI";      // Dropbox folder to list// "; // ZIP file path in Dropbox
const zipFilePath = "/DAYTRADING AI/DAYTRADING AI.zip";  //zip file path in Dropox folder 
