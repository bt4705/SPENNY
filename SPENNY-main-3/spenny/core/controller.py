<<<<<<<< HEAD:spenny_refactor/spenny/core/controller.py
from spenny.core.data import fetch_data
from spenny.core.strategy import is_bull_flag, passes_checklist
from spenny.core.risk import atr_stop, RiskManager
from spenny.core.zones import demand_zones
from spenny.core.ingestion import ingest_all_strategies
from spenny.execution.broker import get_account, get_position, update_stop
from spenny.execution.hedge_bridge import execute
from spenny.agents.llama_agent import suggest_stop
from spenny.config import ATR_MULTIPLIER, USE_AI_STOP
========
...
>>>>>>>> bd56ac96cb521d6e1bfc1fd1322b702719b9c910:spenny/core/controller.py
